...
class Grapher:
    ...
    def generate_gif(self, screenshot_list, gif_path):
        ...
        frames[0].save(gif_path, format='GIF', append_images=frames[1:], save_all=True, duration=1000 / GIF_FRAMES_PER_SECOND, loop=0)
