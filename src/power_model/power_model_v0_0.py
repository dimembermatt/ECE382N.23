...
class PowerModel_V0_0(PowerModelInterface):
    """_summary_
    PowerModel_V0_0 models a very abstract interpretation of the NoS power
    usage. It has the following characteristics:
    - devices have a static power source that provides a maximum fixed amount of
      power at any moment.
    - hardware for each device is given a static idle and active power
      consumption value, which is used for determining power usage over time.
    - timing is determined by the ApplicationModel event timeline.
    """

    def __init__(self) -> None:
        super().__init__("V0_0 Power Model")
